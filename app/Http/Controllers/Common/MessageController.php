...
class MessageController extends Controller
{
    ...
    public function inboxData(Request $request)
    {
        ...
        if(!empty($messages))
        {
            ...
            $data[] = [
                'serial'     => $loop++,
                'photo'      => '<img src="'.asset((!empty($message->sender->photo)?$message->sender->photo:'assets/img/icons/no_user.jpg')).'" alt="" width="64">',
    ...
    public function sentData(Request $request)
    {
        ...
        if(!empty($messages))
        {
            ...
            $data[] = [
                'serial'     => $loop++,
                'photo'      => '<img src="'.asset((!empty($message->receiver->photo)?$message->receiver->photo:'assets/img/icons/no_user.jpg')).'" alt="" width="64">',
    ...
    public function UploadFiles(Request $request)
    {
        ...
        $destinationPath = '/attachments/'; // upload path
